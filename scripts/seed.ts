    ...
    await db.insert(recipes).values([
      {
        ...
        instructions:
          "1. Cook pasta according to package directions. 2. In a large skillet, melt butter and sauté garlic until fragrant. 3. Add heavy cream and bring to a simmer. 4. Gradually whisk in Parmesan cheese until melted and sauce is smooth. 5. Season with salt and pepper. 6. Toss with cooked pasta and garnish with parsley.",
        prep_time: 10,
        cook_time: 20,
        servings: 4,
      },
      {
        ...
        instructions:
          "1. In a large skillet, heat olive oil and 2 tablespoons butter over medium-high heat. 2. Add shrimp and cook for 1-2 minutes per side until pink. 3. Remove shrimp and set aside. 4. Add remaining butter and garlic to the pan and cook until fragrant. 5. Add lemon juice and red pepper flakes, simmer for 2 minutes. 6. Return shrimp to the pan, toss to coat, and cook for another minute. 7. Garnish with fresh parsley.",
        prep_time: 15,
        cook_time: 10,
        servings: 4,
      },
      ...
      },
      {
        ...
        instructions:
          "1. Preheat oven to 275°F. 2. Mix brown sugar, paprika, garlic powder, onion powder, cayenne, salt, and pepper to create a dry rub. 3. Remove membrane from backside of ribs and apply dry rub generously on both sides. 4. Wrap ribs tightly in foil and place on a baking sheet. 5. Bake for 2.5-3 hours until tender. 6. Unwrap ribs, brush with BBQ sauce, and broil for 5 minutes. 7. Let rest before serving.",
        prep_time: 20,
        cook_time: 195,
        servings: 6,
      },
      ...
      },
      {
        ...
        instructions:
          "1. Brown ground beef in a skillet over medium heat until no longer pink. 2. Drain excess fat and add taco seasoning and 2/3 cup water. 3. Simmer for 5 minutes until liquid reduces. 4. Warm tortillas according to package instructions. 5. Assemble tacos by filling tortillas with beef, lettuce, tomatoes, onions, cheese, and avocado. 6. Serve with salsa and sour cream.",
        prep_time: 15,
        cook_time: 15,
        servings: 4,
      },
      {
        ...
        instructions:
          "1. Mix brown sugar, paprika, garlic powder, onion powder, cayenne to create a dry rub. 2. Apply rub generously to pork shoulder. 3. Place in slow cooker with chicken broth. 4. Cook on low for 8 hours until fork-tender. 5. Shred pork with two forks and mix with BBQ sauce. 6. Serve on hamburger buns topped with coleslaw.",
        prep_time: 15,
        cook_time: 480,
        servings: 8,
      },
